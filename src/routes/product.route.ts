...
import { createProduct, deleteProduct, getProductById, getProductByName, getProductLastMonth, getProducts, updateProduct } from "../controllers/product.controller.js";
...
router.get("/product/new/arrvival", getProductLastMonth);
